                ...
                >
                  <Link href={"/"}>
                    <Image
                      ...
                      height={20}
                    />
                    {/* <span className={cn("text-sm font-medium")}>Link</span> */}
                  </Link>
                </Button>
              </BreadcrumbLink>
            </BreadcrumbItem>
            ...
            <BreadcrumbItem>
              {isRenaming ? (
                ...
                <BreadcrumbPage
                  ...
                  className="text-sm hover:text-muted-foreground cursor-pointer font-medium max-w-40 truncate transition-colors"
                >
                  {project?.name ?? <Spinner className="size-4" />}
                </BreadcrumbPage>
              )}
            </BreadcrumbItem>
          </BreadcrumbList>
